...
echo -e "\e[1;34mCreation de 2 groupes.\e[0m"
...
echo -e "\e[1;34mCreation de 2 utilisateurs + affectation des groupes.\e[0m"
...
echo -e "\e[1;34mActions sur le premier dossier.\e[0m"
...
echo -e "\e[1;34mActions sur le second dossier.\e[0m"
...
echo -e "\e[1;34mChangement de propriétaire des elements crées.\e[0m"
chown -R $user1:$user1 "/home/$user1/$folder1"
chown -R $user1:$user1 "/home/$user1/$folder2"

#Actions diverses.
echo -e "\e[1;34mActions diverses.\e[0m"
cd "/home/$user1/$folder1"
cd "/home/$user1/$folder2"

#Copie des fichiers
echo -e "\e[1;34mCopie des fichiers de $folder2 dans $folder1.\e[0m"
cp -r /home/$user1/$folder2/* /home/$user1/$folder1/

#Changement de propriétaire des elements copies.
echo -e "\e[1;34mChangement de propriétaire des elements copies.\e[0m"
chown -R $user1:$user1 "/home/$user1/$folder1"

cd "/home/$user1/$folder1"

#Affichage du contenu du fichier
echo -e "\e[1;34mcontenu du fichier $file2_2 dans $rename1\e[0m"
cat "/home/$user1/$folder1/$file2_2"

#Ecriture du contenu
echo -e "\e[1;34mEcriture du contenu de $file2_2 :\e[0m"
cat "/home/$user1/$folder1/$file2_2" >> "/home/$user1/$folder1/$rename1"

#Copie des fichiers
echo -e "\e[1;34mCopie du dossier $folder1 dans /home/$user2.\e[0m"
...
echo -e "\e[1;34mReglage des droits de $file2_1 (740, aucun droit pour les autres)\e[0m"
chmod 740 "/home/$user2/$folder1/$file2_1"

echo -e "\e[1;34mReglage des droits de $file2_2 (744, lecture seule pour les autres)\e[0m"
...
cd "/home/$user2/"
echo -e "\e[1;34mAffichage des droits attribués dans /home/$user2/$folder1/\e[0m"
ls -al "/home/$user2/$folder1/"

#Creation de l'archive .taz.gz
echo -e "\e[1;34mCreation de l'archive $folder1.taz.gz\e[0m"
tar -czvf "/home/$user2/$folder1.taz.gz" "/home/$user2/$folder1/"

#Affichage des processus pour l'utilisateur en cours
echo -e "\e[1;34mAffichage des processus pour l'utilisateur en cours\e[0m"
ps -u "$SUDO_USER"

#Log des processus pour l'utilisateur en cours dans ~/ps_root.txt
echo -e "\e[1;34mLog des processus pour l'utilisateur en cours dans ~/ps.txt\e[0m"
ps -u "$SUDO_USER" >> "/home/$SUDO_USER/ps.txt"

#Creation du lien symbolique
echo -e "\e[1;34mCreation du lien symbolique\e[0m"
